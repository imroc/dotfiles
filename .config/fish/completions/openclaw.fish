...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from broadcast" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from react" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from reactions" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from delete" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from pin" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from pins" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from permissions" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from create" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from reply" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from upload" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from info" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from timeout" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from kick" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from ban" -l channel -d 'Channel: telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon'
...
complete -c openclaw -n "__fish_seen_subcommand_from agent" -l channel -d 'Delivery channel: last|telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon (default: whatsapp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Delivery channel (last|telegram|discord|slack|feishu|wecom)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Delivery channel (last|telegram|discord|slack|feishu|wecom)'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (telegram, discord, slack, feishu)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (telegram, discord, slack, feishu)'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from capabilities" -l channel -d 'Channel (all|telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon)'
...
complete -c openclaw -n "__fish_seen_subcommand_from resolve" -l channel -d 'Channel (telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logs" -l channel -d 'Channel (all|telegram|whatsapp|discord|googlechat|slack|signal|imessage|feishu|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|wecom|zalouser|tlon)'
